...
import 'package:mensa_italia_app/model/boutique.dart' as _i34;
import 'package:mensa_italia_app/model/deal.dart' as _i33;
import 'package:mensa_italia_app/model/event.dart' as _i31;
import 'package:mensa_italia_app/model/event_schedule.dart' as _i32;
...
class AddEventScheduleListViewArguments {
  ...
  final List<_i32.EventScheduleModel> eventSchedules;
...
class AddScheduleViewArguments {
  ...
  final _i32.EventScheduleModel? event;
...
class AddonBoutiqueProductViewArguments {
  ...
  final _i34.BoutiqueModel product;
...
extension NavigatorStateExtension on _i35.NavigationService {
  ...
  Future<dynamic> navigateToEventShowcaseView({
    _i30.Key? key,
    required _i31.EventModel event,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
  ...
  Future<dynamic> navigateToAddEventScheduleListView({
    _i30.Key? key,
    required List<_i32.EventScheduleModel> eventSchedules,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
  ...
  Future<dynamic> navigateToAddonBoutiqueProductView({
    _i30.Key? key,
    required _i34.BoutiqueModel product,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
