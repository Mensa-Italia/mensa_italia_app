...
class StartPayMode extends StatefulWidget {
  ...
  final String startPayPal;
  final dio.CookieManager cookieManager;
...
class _StartPayModeState extends State<StartPayMode> {
  ...
  init() async {
    (await widget.cookieManager.cookieJar.loadForRequest(Uri.parse("https://www.cloud32.it"))).forEach((element) {
      CookieManager.instance().setCookie(
          url: Uri.parse("https://www.cloud32.it"),
          name: element.name,
          value: element.value,
    ...
    return Scaffold(
      ...
      body:InAppWebView(
        initialUrlRequest: URLRequest(
          url: Uri.parse("https://www.cloud32.it/Associazioni/utenti/rinnovo"),
          headers: {
        ...
        initialData: InAppWebViewInitialData(
          ...
          baseUrl: Uri.parse("https://www.cloud32.it/Associazioni/utenti/rinnovo"),
        ...
        onLoadStart: (inawc, str) async {
          try{
            if(str.toString()=="https://www.cloud32.it/Associazioni/utenti/home") {
