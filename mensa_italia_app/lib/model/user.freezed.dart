...
class _$UserModelImpl implements _UserModel {
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, username: $username, name: $name, avatar: $avatar, email: $email, expireMembership: $expireMembership, powers: $powers, addons: $addons)';
  }
...
abstract class _UserModel implements UserModel {
  const factory _UserModel(
      ...
      required final List<String> powers,
      required final List<String> addons}) = _$UserModelImpl;
