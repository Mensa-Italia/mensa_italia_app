...
final internalAddonsList = ["contacts", "testmakers", "documents"];
...
class _addons extends ViewModelWidget<MembershipPageModel> {
  ...
  Widget build(BuildContext context, MembershipPageModel viewModel) {
    return Row(
      mainAxisAlignment: viewModel.favsAddons.length == 6 ? MainAxisAlignment.spaceEvenly : MainAxisAlignment.center,
...
class _addonsCard extends StatelessWidget {
  ...
  const _addonsCard({Key? key, required this.icon, required this.onTap}) : super(key: key);
